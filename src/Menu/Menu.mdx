...
import { Playground, Props } from "docz"; import { Avatar, MenuOption, Menu, } from "../index";
...
<Playground>
  {() =>
  {
    ...
    return (
      <Menu
        button={<div style={{ width: 100, backgroundColor: 'gray', textAlign: 'center', color: '#fff' }}>menu</div>}
        hover
        options={[
          {
            id: '1',
        ...
        getContextMenu={(openMenu) =>
        {
          return (
            <div
              ...
              style={{ width: 500, height: 300, backgroundColor: '#eeeeee', textAlign: 'center' }}
            >
